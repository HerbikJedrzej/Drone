...
const Oscilation::ComplexNumbers Oscilation::ComplexNumbers::operator+(const ComplexNumbers& val) const{
...
const Oscilation::ComplexNumbers Oscilation::ComplexNumbers::operator*(const double& val) const{
