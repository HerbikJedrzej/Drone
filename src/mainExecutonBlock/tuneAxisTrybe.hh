...
void tuneAxisXTrybe(GlobalStruct& globals, DriversGroup& diversGroup, void(*delay)(uint32_t));
void tuneAxisYTrybe(GlobalStruct& globals, DriversGroup& diversGroup, void(*delay)(uint32_t));
